...
insert into customer values(223136,'anish','rajnish','anish.22@gmail.com','858 kathmandu shantinagar prayagmarg 31','michaelstad','connecticut'
                                                                ,'Cape Verde',current_timestamp());

update customer set FIRST_NAME='anish',update_timestamp = current_timestamp()::timestamp_ntz where customer_id = 72;
...
insert into customer values(223136,'anish','rajnish','anish.22@gmail.com','595 Benjamin Forge Suite 124','Michaelstad','Connecticut'
                            ,'Cape Verde',current_timestamp());
update customer set FIRST_NAME='anish' where customer_id=7523;
